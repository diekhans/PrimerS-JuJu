...
def test_SNAI1(request, genome_data, wtc11_targets_specs_set1, hg38_uniqueness_query):
...
def test_BBC3(request, genome_data, wtc11_targets_specs_set1, hg38_uniqueness_query):
...
def test_ZBTB45(request, genome_data, wtc11_targets_specs_set1, hg38_uniqueness_query):
...
def test_CERNA1(request, genome_data, wtc11_targets_specs_set1, hg38_uniqueness_query):
    # regression for incorrect uniqueness checks when results overlap target
    primer_designs = run_primer_design_test(test_id(request), genome_data, wtc11_targets_specs_set1, "CERNA1+1",
