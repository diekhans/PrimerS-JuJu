...
def _target_build(config_hg38, targets_specs, target_id, num_trans, region_5p, region_3p):
...
def test_target_build_exonic(config_hg38, wtc11_targets_specs_set1):
    ...
    primer_targets = _target_build(config_hg38, wtc11_targets_specs_set1, "SNAI1+1", 1,
                                   region_5p, region_3p)
...
def test_target_build_junc(config_hg38, wtc11_targets_specs_set1):
    region_5p = Coords("chr4", 2043862, 2043922, strand='+', size=190214555)
    region_3p = Coords("chr4", 2042041, 2042366, strand='+', size=190214555)
    primer_targets = _target_build(config_hg38, wtc11_targets_specs_set1, "C4orf48+1", 1,
                                   region_5p, region_3p)
...
def test_target_build_junc2(config_hg38, wtc11_targets_specs_set1):
    ...
    primer_targets = _target_build(config_hg38, wtc11_targets_specs_set1, "BBC3+1", 1,
                                   region_5p, region_3p)
    # coords were swapped
    _check_primer_targets(primer_targets, region_3p, region_5p)
...
def test_target_build_trim_sj(config_hg38, wtc11_targets_specs_set1):
    ...
    primer_targets = _target_build(config_hg38, wtc11_targets_specs_set1, "ARPC2+1", 1,
                                   region_5p, region_3p)
    # coords were swapped
...
def test_target_build_trim_exon1(config_hg38, wtc11_targets_specs_set1):
    ...
    primer_targets = _target_build(config_hg38, wtc11_targets_specs_set1, "LRFN3+2", 1,
                                   region_5p, region_3p)
    # coords were swapped
    _check_primer_targets(primer_targets,
