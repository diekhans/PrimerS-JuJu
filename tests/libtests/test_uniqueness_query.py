...
def test_uniqueness_query_transcriptome(hg38_uniqueness_query):
    ...
    assert hits == [TranscriptomeHit(ispcr_id='ENST00000244050.3__SNAI1', trans_id='ENST00000244050.3', gene_name='SNAI1',
                                     left_features=[ExonFeature(genome=Coords(name='chr20', start=49983006, end=49983026, strand='+', size=64444167),
                                                                trans=Coords(name='ENST00000244050.3__SNAI1', start=27, end=47, strand='+', size=1705))],
                                     right_features=[ExonFeature(genome=Coords(name='chr20', start=49988321, end=49988341, strand='+', size=64444167),
                                                                 trans=Coords(name='ENST00000244050.3__SNAI1', start=1140, end=1160, strand='+', size=1705))],
...
def test_uniqueness_query_transcriptome_junc(hg38_uniqueness_query):
    ...
    assert hits == [TranscriptomeHit(ispcr_id='ENST00000594051.6__ZBTB45', trans_id='ENST00000594051.6', gene_name='ZBTB45',
                                     left_features=[ExonFeature(genome=Coords(name='chr19', start=58514260, end=58514280, strand='+', size=58617616),
                                                                trans=Coords(name='ENST00000594051.6__ZBTB45', start=731, end=751, strand='-', size=2129))],
                                     right_features=[ExonFeature(genome=Coords(name='chr19', start=58517667, end=58517673, strand='+', size=58617616),
                                                                 trans=Coords(name='ENST00000594051.6__ZBTB45', start=2054, end=2060, strand='-', size=2129)),
                                                     ExonFeature(genome=Coords(name='chr19', start=58519741, end=58519755, strand='+', size=58617616),
                                                                 trans=Coords(name='ENST00000594051.6__ZBTB45', start=2060, end=2074, strand='-', size=2129))],
